...
int main(int argc, char* argv[])
{
    ...
    if (!sbuffer.loadFromFile("./resources/Audio/whoosh.wav"))
    {
    ...
    winMusic.openFromFile("./resources/Audio/win_trumpets.ogg");
    winMusic.setVolume(20.0f);
    bool winMusicStarted = FALSE;

    backgroundMusic.openFromFile("./resources/Audio/background_music.mp3");
    ...
    std::string path = "./resources/SlidingPuzzle/";
    for (int i = 0; i < 11; i++)
    {
